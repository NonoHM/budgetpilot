...
- [Categorization rules](./using/rules.md): the 156 that ship, and writing
  your own.
- [Cash-flow forecast](./using/cash-flow-forecast.md): what feeds the
  projection, and what it means when it says nothing.
...
model for the other. Neither exists in the app until that is done. A
...
- [Cash-flow forecast](./reference/cash-flow-forecast.md): the gates,
  the anchor and the three horizons.
